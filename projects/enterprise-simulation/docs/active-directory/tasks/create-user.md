...
![open active directory users and computers](../../../screenshots/create-user/01-open-aduc.png)

> [!note]
> You should be able to see the Windows 11 VM that you joined to the domain under Computers.

![verify joined client](../../../screenshots/create-user/02-verify-w11-joined-domain.png)
...
![location for new user](../../../screenshots/create-user/03-aduc-users.png)
...
![create a new user](../../../screenshots/create-user/04-create-new-user.png)
...
![new object user](../../../screenshots/create-user/05-new-user-object.png)
...
![filling out user information](../../../screenshots/create-user/06-filling-user-details.png)
...
![set initial password](../../../screenshots/create-user/15-set-user-password.png)

## 6. Finish creating the user

Review the summary page, then click `Finish`.

![finish and review user](../../../screenshots/create-user/07-review-user.png)
...
![user should appear in container](../../../screenshots/create-user/08-created-user-should-appear.png)
...
1. Select `Other user` in the bottom left
    ...
    - ![select other user](../../../screenshots/create-user/09-login-screen.png)

2. Sign in using either:
    - `DOMAIN\username`
    - `username@domain.name`

    - ![sign in to domain](../../../screenshots/create-user/10-log-into-created-user.png)

If you left the `User must change password at next logon` checked, you will see the prompt to change the user's password.

![change password before signing in](../../../screenshots/create-user/11-if-password-change-checked.png)
![creating a new password](../../../screenshots/create-user/12-change-password-logon.png)
![password has been changed](../../../screenshots/create-user/13-password-changed.png)
...
![verify user](../../../screenshots/create-user/14-verify-domain-user.png)
